...
class NorthstarScraper(Scraper):
    ...
    def __init__(self, ns_url='https://profile.dosomething.org'):
        """Set Northstar API with all the retry good of Quasar Web Scraper."""
        Scraper.__init__(self, ns_url)
        global self.auth_token = self.getToken()
    ...
    def get(self, path, query_params=''):
        ...
        try:
            auth_headers = {'Authorization': 'Bearer ' + str(self.auth_token)}
